...
save(german_credit, file = 'C:/Users/User/Desktop/Final Year Project/R Code to Prepare German Credit Data/german_credit')
write.csv(german_credit, 'C:/Users/User/Desktop/Final Year Project/R Code to Prepare German Credit Data/german_credit.csv',
          row.names = FALSE)
